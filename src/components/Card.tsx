...
${tw`w-[250px] h-[320px] border border-black rounded-[24px] mx-5 my-16 p-7 shadow-[10px_10px_10px_-7px_rgba(0,0,0,0.3)] select-none cursor-pointer transition hover:ease-in hover:scale-110 scale-100 ease-out duration-200`}
`
